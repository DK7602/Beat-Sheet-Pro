...
function renderProjectPicker(){
  ...
  els.projectPicker.textContent = activeIsArchived ? "Projects" : (projects.length ? getProjectDisplayName(active) : "No projects");
  els.projectPicker.title = els.projectPicker.textContent || "Projects";
...
els.projectPicker?.addEventListener("click", ()=> openProjectOverlay());
