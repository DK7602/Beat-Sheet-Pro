...
function wireNotesEditor(){
  ...
  ed.addEventListener("click", (e)=>{
    if(e.target?.closest?.('.notes-checklist-box')) return;
  ...
  ed.addEventListener("focus", ()=>{ activeNotesEditable = getCurrentNotesEditable() || ed; applyNotesTypingColor(getNotesTypingColor(), false); saveNotesSelection(); scheduleNotesRhymeRefresh(); });
